...
//        parameters.put("out_trade_no","3271760578");//商户订单号
//        parameters.put("total_fee","0.01");//金额
//        parameters.put("subject","发起一笔支付");//订单标题
//        parameters.put("body","发起一笔支付");//订单m描述
//        parameters.put("show_url","http://localhost:8080/gift/2");//商品展示页
//        parameters.put("sign",eapayUtils.signMd5(parameters));//商户签名
        ...
        parameters.put("subject",pay.getUid()+"会员发起一笔"+pay.getMoney()+"积分充值");//订单标题
        parameters.put("body",pay.getUid()+"会员发起一笔"+pay.getMoney()+"积分充值，积分充值不支持退款!");//订单m描述
